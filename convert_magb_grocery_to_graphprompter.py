...
RAW_ROOT = Path("/home/liyijun/gpt-mmge/MAGB/CD")
OUT_DIR = Path("/home/liyijun/gpt-mmge/MAGB/CD/FineFeatures_convert")

csv_path = RAW_ROOT / "CD.csv"
text_feat_path = RAW_ROOT / "TextFeature" / "Grocery_roberta_base_256_mean.npy"
img_feat_path = RAW_ROOT / "ImageFeature" / "Grocery_openai_clip-vit-large-patch14.npy"
graph_pt_path = RAW_ROOT / "CDGraph.pt"
...
def main():
    ...
    out_graph_path = OUT_DIR / "Grocery_grocery_ori_text_aug_imgText_ori_img_graph_data.pt"
    ...
    split_path = OUT_DIR / "Grocery_split.json"
