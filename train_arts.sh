...
for num_epochs in 15; do
  for lr in 1e-5 2e-5; do
    for num_queries in 2 4; do
      for num_hops in 2; do
        for sample_neighbor_size in 5 10; do

        output_dir="output_arts/exp1/ep${num_epochs}_lr${lr}_nq${num_queries}_hop${num_hops}_seq${sample_neighbor_size}"
